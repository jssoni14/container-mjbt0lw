...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mjbt0lw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mjbt0lw.containers.anotherwebservice.com/
...
```
git clone git@github.com:jssoni14/container-mjbt0lw.git
cd container-mjbt0lw
```
...
```
docker attach container-mjbt0lw
```
